    ...
    <div className="flex flex-col sm:flex-row p-5 gap-6">
      ...
      <div className="flex-1">
        ...
        <div className="p-7 flex flex-wrap gap-4">
          ...
          {loading && <p className="text-lg text-center w-full">Loading...</p>}
          {!loading &&
            listings &&
        ...
        {showMore && (
          <button
            className="text-center w-full flex items-center gap-2"
            onClick={onShowMoreClick}
          >
            Show more <FaCircleArrowDown className="text-red-800" />
          </button>
        )}
      </div>
    </div>
