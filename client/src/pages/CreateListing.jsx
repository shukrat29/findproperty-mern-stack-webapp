...
const CreateListing = () => {
  ...
  return (
    <main className="p-3 max-w-4xl mx-auto">
      <h1 className="text-lg font-semibold text-center my-6">
        Create a Listing
      </h1>
        ...
        <div className="flex flex-col flex-1 gap-4">
          ...
          <div className=" flex gap-4">
            ...
            <button
              ...
              className="p-2 text-green-700 border border-green-700 rounded  uppercase hover:shadow-lg "
            >
            ...
            formData.imageUrls.map((url, index) => (
              ...
              >
                ...
                <button
                  ...
                  className="p-2 text-red-600 uppercase"
                >
                  Delete
                </button>
              </div>
            ))}
          <button className="p-2 bg-slate-700 text-white rounded-lg uppercase">
            Create Listing
          </button>
        </div>
      </form>
